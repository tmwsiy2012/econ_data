...
INSERT INTO ete_categories (element_id, scale_id, category, category_description) VALUES ('2.D.1', 'RL', 2, 'High School Diploma (or GED or High School Equivalence Certificate)');
INSERT INTO ete_categories (element_id, scale_id, category, category_description) VALUES ('2.D.1', 'RL', 3, 'Post-Secondary Certificate - awarded for training completed after high school (for example, in Personnel Services, Engineering-related Technologies, Vocational Home Economics, Construction Trades, Mechanics and Repairers, Precision Production Trades)');
